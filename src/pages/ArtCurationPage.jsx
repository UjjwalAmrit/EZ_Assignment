    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="relative pt-32 pb-16 md:py-24 overflow-hidden">
          ...
          <img
            src="/art-curation/icon-03.png" // Assumed path
            alt="Frame icon"
            className="pointer-events-none select-none hidden md:block absolute top-[24%] right-16 w-24 opacity-80"
          />
          <img
            src="/art-curation/icon-01.png" // Assumed path
            alt="Grid icon"
            className="pointer-events-none select-none hidden md:block absolute top-[55%] right-32 w-24 opacity-80"
          />
          <img
            src="/art-curation/icon-04.png" // Assumed path
            alt="Building icon"
            className="pointer-events-none select-none hidden md:block absolute bottom-16 right-24 w-24 opacity-80"
          />
          <img
            src="/art-curation/icon-02.png" // Assumed path
            alt="Shapes icon"
          ...
          <Container>
            ...
            <div className="mb-12">
              <Link to="/" className="inline-block" aria-label="Go back">
                ...
                <img src="/art-curation/frame-2.png" alt="Back" className="w-24 h-auto" />
              </Link>
            </div>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative bg-white p-4 pb-12 rounded-sm shadow-xl w-[380px]">
                  <div className="relative w-full h-[420px] bg-gray-100 overflow-hidden">
                    {/* This is the art curation image from your Services section */}
                    <img
                      src="/art-curation/hero.png"
                      alt="Art Curation"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <p className="mt-3 text-center font-display text-lg text-ink">Art Curation</p>
                </div>
              </div>

              {/* Right Column: Text Content */}
              <div className="space-y-5 text-ink/90 leading-7">
                <p>Art isn't meant to sit on distant walls - it's meant to breathe, to travel, to belong. Through every festival, every performance, and every gathering, we help stories find their stage and their people.</p>
                <p className="font-semibold text-ink">V curates:</p>
                ...
                <div className="flex items-center gap-3 pt-4">
                  ...
                  <img src="/art-curation/vector.png" alt="arrow" className="w-16 h-auto absolute bottom-[15%]" />
                </div>
              </div>
            </div>
          </Container>
